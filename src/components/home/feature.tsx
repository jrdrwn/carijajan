  ...
  return (
    <section className="container mx-auto py-16 px-2 lg:px-0">
      <div className="grid lg:grid-cols-3 lg:grid-rows-2 gap-4 grid-flow-row grid-cols-1">
        <Card className="lg:row-span-2 p-2 lg:p-6">
          <CardContent className="flex flex-col gap-4 p-2 lg:p-6">
            <Image
              src={
        ...
        <Card className="lg:col-span-1 p-2 lg:p-6">
          <CardContent className="flex flex-col gap-4 p-2 lg:p-6">
            <Image
              src={
        ...
        <Card className="lg:col-span-2 p-2 lg:p-6 ">
          <CardContent className="flex flex-col gap-4 p-2 lg:p-6">
            <Image
              src={
